...
{
  "id": "frontmatter-preface",
  "level": "1",
  "url": "frontmatter-preface.html",
  "type": "Preface",
  "number": "",
  "title": "Preface",
...
{
  "id": "sec-first-examples",
  "level": "1",
  "url": "sec-first-examples.html",
  "type": "Section",
  "number": "1.2",
  "title": "Examples",
...
{
  "id": "sec-first-examples-3",
  "level": "2",
  "url": "sec-first-examples.html#sec-first-examples-3",
  "type": "Example",
  "number": "1.2.1",
  "title": "",
...
{
  "id": "sec-first-examples-5",
  "level": "2",
  "url": "sec-first-examples.html#sec-first-examples-5",
  "type": "Example",
  "number": "1.2.2",
  "title": "",
...
{
  "id": "thm-first-examples-theorem",
  "level": "2",
  "url": "sec-first-examples.html#thm-first-examples-theorem",
  "type": "Theorem",
  "number": "1.2.3",
  "title": "Theorem Title.",
...
{
  "id": "cor-first-examples-corollary",
  "level": "2",
  "url": "sec-first-examples.html#cor-first-examples-corollary",
  "type": "Corollary",
  "number": "1.2.4",
  "title": "",
...
{
  "id": "remark-first-examples-context",
  "level": "2",
  "url": "sec-first-examples.html#remark-first-examples-context",
  "type": "Remark",
  "number": "1.2.5",
...
},
{
  ...
  "number": "2",
  "title": "(No title)",
  "body": " (No title)  Try adding your own content here! This chapter doesn't have sections.  "
},
{
  "id": "sec-features-blocks",
  "level": "1",
  "url": "sec-features-blocks.html",
  "type": "Section",
  "number": "3.1",
...
},
{
  ...
  "level": "2",
  "url": "sec-features-blocks.html#thm_features-blocks-my-theorem",
  "type": "Theorem",
  "number": "3.1.1",
  "title": "My Theorem.",
...
{
  "id": "sec-features-blocks-4",
  "level": "2",
  "url": "sec-features-blocks.html#sec-features-blocks-4",
  "type": "Example",
  "number": "3.1.2",
  "title": "",
...
{
  "id": "sec-features-blocks-6",
  "level": "2",
  "url": "sec-features-blocks.html#sec-features-blocks-6",
  "type": "Figure",
  "number": "3.1.3",
  "title": "",
...
},
{
  "id": "sec-latex-image",
  "level": "1",
  "url": "sec-latex-image.html",
  "type": "Section",
  "number": "4.1",
  "title": "LaTeX-Image Example",
  "body": " LaTeX-Image Example   The graph made by TikZ   A 5-cycle     "
},
{
  "id": "fig-tikz",
  "level": "2",
  "url": "sec-latex-image.html#fig-tikz",
  "type": "Figure",
  "number": "4.1.1",
  "title": "",
...
},
{
  "id": "sec-sageplot",
  "level": "1",
  "url": "sec-sageplot.html",
  "type": "Section",
  "number": "4.2",
  "title": "SagePlot Examples",
  "body": " SagePlot Examples   The parabola made by SageMath   A parabola      The paraboloid made by SageMath   A paraboloid     "
},
{
  "id": "fig-sage2d",
  "level": "2",
  "url": "sec-sageplot.html#fig-sage2d",
  "type": "Figure",
  "number": "4.2.1",
  "title": "",
  "body": " The parabola made by SageMath   A parabola    "
},
{
  "id": "fig-sage3d",
  "level": "2",
  "url": "sec-sageplot.html#fig-sage3d",
  "type": "Figure",
  "number": "4.2.2",
  "title": "",
  "body": " The paraboloid made by SageMath   A paraboloid    "
},
{
  "id": "sec-asymptote",
  "level": "1",
  "url": "sec-asymptote.html",
  "type": "Section",
  "number": "4.3",
  "title": "Asymptote Example",
  "body": " Asymptote Example   Canada   Image of a Canadian flag     "
},
{
  "id": "fig-asymptote",
  "level": "2",
  "url": "sec-asymptote.html#fig-asymptote",
  "type": "Figure",
  "number": "4.3.1",
  "title": "",
  "body": " Canada   Image of a Canadian flag    "
},
{
  "id": "sec-webwork",
  "level": "1",
  "url": "sec-webwork.html",
  "type": "Section",
  "number": "4.4",
  "title": "WeBWorK Example",
  "body": " WeBWorK Example     Compute the sum of and     Add and together.               "
},
{
  "id": "sec-webwork-2",
  "level": "2",
  "url": "sec-webwork.html#sec-webwork-2",
  "type": "Checkpoint",
  "number": "4.4.1",
  "title": "",
  "body": "   Compute the sum of and     Add and together.              "
},
{
  "id": "sec-mom",
  "level": "1",
  ...
  "number": "4.5",
  "title": "MyOpenMath",
  "body": " MyOpenMath    Here is a problem from MyOpenMath.     "
},
{
  "id": "sec-mom-2",
  "level": "2",
  "url": "sec-mom.html#sec-mom-2",
  "type": "Checkpoint",
  "number": "4.5.1",
  "title": "",
  "body": "  Here is a problem from MyOpenMath.    "
},
{
  "id": "sec-youtube",
  "level": "1",
  "url": "sec-youtube.html",
  "type": "Section",
  "number": "4.6",
  "title": "YouTube Example",
  "body": " YouTube Example   "
},
{
  "id": "sec-interactive",
  "level": "1",
  "url": "sec-interactive.html",
  "type": "Section",
  "number": "4.7",
  "title": "Interactive Example",
  "body": " Interactive Example    Infinity, from the JSXGraph Showcase    "
},
{
  "id": "sec-interactive-2",
  "level": "2",
  "url": "sec-interactive.html#sec-interactive-2",
  "type": "Figure",
  "number": "4.7.1",
  "title": "",
